...
class Validator
{
    ...
    public static $rulesMap = [
        ...
        'bool' => Rule\BooleanRule::class, // alias for boolean
        ...
        'gt' => Rule\GreaterThanRule::class, // alias for greater_than
        'hash' => Rule\HashRule::class,
        'in_array' => Rule\InArrayRule::class,
        'integer' => Rule\IntegerRule::class,
        'int' => Rule\IntegerRule::class, // alias for integer
        'is_array' => Rule\IsArrayRule::class,
        'array' => Rule\IsArrayRule::class, // alias for is_array
        'is_float' => Rule\IsFloatRule::class,
        'float' => Rule\IsFloatRule::class, // alias for is_float
        'is_string' => Rule\IsStringRule::class,
        'string' => Rule\IsStringRule::class, // alias for is_string
        ...
        'lt' => Rule\LessThanRule::class, // alias for less_than
